...
ユーザーコミュニティによって運営されている便利なパッケージマネージャーがあります🎉
Reactorではコミュニティによって作成されたエフェクトやツールが多数登録されていて
誰でも簡単にインストールして使用することができます
実は、このReactorに登録されているツールは誰でも作成可能で
手順に従って申請すれば
自作のエフェクトやツールをReactorに登録できちゃうんです！！😆
...
:::message alert
**やりとりや入力はすべて英語です！**
申請先のWeSuckLessは英語圏のコミュニティなので、フォーラムへの投稿はもちろん、作成するパッケージ内の名前や説明文など**すべて英語**で入力・やりとりする必要があります。
...
:::message alert
**添付ファイルのサイズに注意！**
巨大なファイルは🙅‍♀️NGです、ファイルサイズは可能な限り軽量化しておきましょう！
:::
