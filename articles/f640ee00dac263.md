...
`degree` から `radian` に ♻️ 変換してから`sin`, `cos`, `tan` に渡す必要があります
...
![rectangle](/images/articles/rotation-size/aspect-ratio.png)
_同じ値を設定しても長方形_

### アスペクト比計算

アスペクト比は`comp:GetPrefs`を用いて
...
![square](/images/articles/rotation-size/square.png)
_高さにアスペクト比をかければ正方形_
...
:::message alert
Start Render Script に不正な script を入力すると DaVinci Resolve がクラッシュするので注意 ❗
DaVinci Resolve では script に関して保護機能がなにもないです
本体も巻き込まれます 😱☠️
:::

![Start Render Script](/images/articles/rotation-size/start-render-script.png)
_Start Render Script の場所_
...
![幅 1](/images/articles/rotation-size/wcos.png)
_幅 1_
...
![幅 2](/images/articles/rotation-size/hsin.png)
_幅 2_
...
![高さ 1](/images/articles/rotation-size/wsin.png)
_高さ 1_
...
![高さ 2](/images/articles/rotation-size/hcos.png)
_高さ 2_
...
https://x.com/i/status/1890735145168093284
...
:::message
計算式は 7shi さんに教えてもらいました、ありがとうございます 🙏
@[card](https://zenn.dev/7shi)
:::
...
$$
w1=Rectangle1.Width \\
h1=Rectangle1.Height
$$

$$
w2=Rectangle2.Width \\
h2=Rectangle2.Height
$$
...
実際に回転にはさせたい場合はこのアレンジが必要です 😎
https://x.com/i/status/1891888825871331816

表示できなくなる前に折り返すパターン
https://x.com/i/status/1891888954753827287
