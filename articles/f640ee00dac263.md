...
👆 やりたいのはこちら、黄色い四角形を収める青い四角形の幅・高さの計算方法
...
```lua
W = ((Rectangle1.Width * cos(rad(Angle))) + ((Rectangle1.Height * (9/16)) * sin(rad(Angle))))
H = ((Rectangle1.Width * sin(rad(Angle))) + ((Rectangle1.Height * (9/16)) * cos(rad(Angle)))) * 16/9
```
